...
<div class="container">
    <div class="work d-flex justify-content-center">
        <form method="post" action="<?= BASE_URL . 'modifyEstimate'; ?>" class="w-100">
                                    ...
                                    <tbody class="task<?= $taskDetails['taskNumber'] ?> table-group-divider">
                                        ...
                                        ?>
                                            <tr class="rowId row<?= $taskDetails['taskNumber'] . $productByTask->getRow() ?>" id="<?= $taskDetails['taskNumber'] . $productByTask->getRow() ?>">
                                                ...
                                                <td>
                                                    <select class="form-select type" id="type" aria-label="Default select example" style="min-width: 150px">
